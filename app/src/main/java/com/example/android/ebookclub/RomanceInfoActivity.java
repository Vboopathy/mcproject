...
public class RomanceInfoActivity extends AppCompatActivity {
        ...
        mSendFeedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mReview.getText().toString().isEmpty()) {
                    Toast.makeText(RomanceInfoActivity.this, "Please review the book", Toast.LENGTH_LONG).show();
                } else {
                    mReview.setText("");
                    mRatingBar.setRating(0);
                    Toast.makeText(RomanceInfoActivity.this, "Thank you for feedback", Toast.LENGTH_SHORT).show();
                }
            }
        });
